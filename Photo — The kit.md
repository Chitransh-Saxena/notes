...
- **APS-C**, 24.2MP, RF mount, DIGIC X
- **Crop factor 1.6×** — this matters constantly, see below
- **Dual Pixel CMOS AF II** with subject detection (people, animals, vehicles).
  The autofocus is genuinely excellent and is the best thing about this body.
- ISO 100–32000 native
- Mechanical shutter to 1/4000; electronic to 1/8000
- **No in-body stabilisation.** The single most consequential limitation.
...
- A full-frame lens on an APS-C body, so the field of view is
  **35 × 1.6 ≈ 56mm equivalent** — a "normal" lens, close to how the eye frames
  ...
  cramped landscape.
- **Hybrid IS** in the lens — roughly 5 stops. Since the body has none, *all*
  stabilisation comes from here.
- **0.5× macro**, which is a genuinely useful bonus and largely why this lens is
  the one to own first.
