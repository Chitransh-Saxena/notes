...
The single most common way to start badly is to buy a drone first. Almost
everyone does it, crashes it in the first minute, and spends the next fortnight
waiting for a replacement part they don't yet know how to fit.
...
Beginners budget for the build. The money actually goes on the *crash* budget:
props, arms, a spare stack, the motor you burn out learning that grass eats
props. Assume the consumables will match the build cost over the first year, and
you will not be unpleasantly surprised.
...
- **Fear.** A sim reset costs nothing. Your first real dive over concrete does
  not feel remotely the same, and that is a skill of its own.
- **Failure modes.** Voltage sag, a loose motor screw, video breakup at range.

## Where the money goes wrong

- Digital goggles before you can hover. They are wonderful and they will still
  be wonderful in three months.
